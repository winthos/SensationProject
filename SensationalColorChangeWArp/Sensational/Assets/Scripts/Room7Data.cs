...
public class Room7Data : MonoBehaviour 
{
	...
	void Update ()
    {
        if (StartUpdatingTime == true)
        {
            ...
            gameObject.GetComponent<DataNStuff>().UpdateTimeInRoom7(TimeSpentInThisRoom);

            //get time spent in normal time
            NormalTimeSpentInThisRoom = TimeSpentInThisRoom - TimeSpentInStoppedTimeInThisRoom;
            gameObject.GetComponent<DataNStuff>().UpdateNormalTimeInRoom7(NormalTimeSpentInThisRoom);
            ...
            if (GameObject.Find("LevelGlobals").GetComponent<LevelGlobals>().TimeStopped == true)
            {
                ...
                gameObject.GetComponent<DataNStuff>().UpdateStoppedTimeInRoom7(TimeSpentInStoppedTimeInThisRoom);
            }
            ...
            if (GameObject.Find("LevelGlobals").GetComponent<LevelGlobals>().TimeStopped == true && Input.GetMouseButtonUp(1) == true)
            {
                ...
                gameObject.GetComponent<DataNStuff>().UpdateNumberOfTimeStopsInRoom7(TimesTimeHasStoppedInThisRoom);
            }
            ...
            if (Input.GetMouseButtonDown(0) == true && GameObject.Find("FirstPersonCharacter").GetComponent<StandActivator>().ReadyToActivate == true)
            {
                ...
                gameObject.GetComponent<DataNStuff>().UpdateNumberOfShotsInRoom7(ShotsFiredInThisRoom);
            }
        }
    }
}
