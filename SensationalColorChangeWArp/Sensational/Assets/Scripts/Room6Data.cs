...
public class Room6Data : MonoBehaviour 
{
	...
	void Update ()
    {
        if (StartUpdatingTime == true)
        {
            ...
            gameObject.GetComponent<DataNStuff>().UpdateTimeInRoom6(TimeSpentInThisRoom);

            //get time spent in normal time
            NormalTimeSpentInThisRoom = TimeSpentInThisRoom - TimeSpentInStoppedTimeInThisRoom;
            gameObject.GetComponent<DataNStuff>().UpdateNormalTimeInRoom6(NormalTimeSpentInThisRoom);
            ...
            if (GameObject.Find("LevelGlobals").GetComponent<LevelGlobals>().TimeStopped == true)
            {
                ...
                gameObject.GetComponent<DataNStuff>().UpdateStoppedTimeInRoom6(TimeSpentInStoppedTimeInThisRoom);
            }
            ...
            if (GameObject.Find("LevelGlobals").GetComponent<LevelGlobals>().TimeStopped == true && Input.GetMouseButtonUp(1) == true)
            {
                ...
                gameObject.GetComponent<DataNStuff>().UpdateNumberOfTimeStopsInRoom6(TimesTimeHasStoppedInThisRoom);
            }
            ...
            if (Input.GetMouseButtonDown(0) == true && GameObject.Find("FirstPersonCharacter").GetComponent<StandActivator>().ReadyToActivate == true)
            {
                ...
                gameObject.GetComponent<DataNStuff>().UpdateNumberOfShotsInRoom6(ShotsFiredInThisRoom);
            }
        }
    }
}
