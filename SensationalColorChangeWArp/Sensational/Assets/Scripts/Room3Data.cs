...
public class Room3Data : MonoBehaviour 
{
	...
	void Update ()
    {
        if (StartUpdatingTime == true)
        {
            ...
            gameObject.GetComponent<DataNStuff>().UpdateTimeInRoom3(TimeSpentInThisRoom);

            //get time spent in normal time
            NormalTimeSpentInThisRoom = TimeSpentInThisRoom - TimeSpentInStoppedTimeInThisRoom;
            gameObject.GetComponent<DataNStuff>().UpdateNormalTimeInRoom3(NormalTimeSpentInThisRoom);
            ...
            if (GameObject.Find("LevelGlobals").GetComponent<LevelGlobals>().TimeStopped == true)
            {
                ...
                gameObject.GetComponent<DataNStuff>().UpdateStoppedTimeInRoom3(TimeSpentInStoppedTimeInThisRoom);
            }
            ...
            if (GameObject.Find("LevelGlobals").GetComponent<LevelGlobals>().TimeStopped == true && Input.GetMouseButtonUp(1) == true)
            {
                ...
                gameObject.GetComponent<DataNStuff>().UpdateNumberOfTimeStopsInRoom3(TimesTimeHasStoppedInThisRoom);
            }
            ...
            if (Input.GetMouseButtonDown(0) == true && GameObject.Find("FirstPersonCharacter").GetComponent<StandActivator>().ReadyToActivate == true)
            {
                ...
                gameObject.GetComponent<DataNStuff>().UpdateNumberOfShotsInRoom3(ShotsFiredInThisRoom);
            }
        }
    }
}
